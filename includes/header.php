        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:PradeepSunil@gmail.com">PradeepSunil@gmail.com</a> 
            </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:+91-9242864383">+91-9242864383</a> 
            </div>
            <div class="social-follow">
              <ul>
                <li><a href="https://www.facebook.com"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                <li><a href="https://www.x.com"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
            ...
            <?php } else { ?>
              <div class="welcome_text">Welcome To Car rental portal</div>
            <?php } ?>
          </div>
        </div>
      </div>
